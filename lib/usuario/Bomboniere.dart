                    ...
                    children: <Widget>[
                      Column(
                        children: <Widget>[
                                    ...
                                    children: <Widget>[
                                      ...
                                      Column(
                                        ...
                                        children: <Widget>[
                                          Row(
                                            children:const <Widget>[
                                              Text("Combos",style: TextStyle(fontWeight: FontWeight.bold, fontSize: 20, color: Colors.white),)
                                            ],

                                          ),
                                          Row(
                                            children:const <Widget>[
                                              Text("Selecione o tamanho de sua ",style: TextStyle(fontWeight: FontWeight.bold, fontSize: 15, color: Colors.white),)
                                            ],
                                          ),
                                          Row(
                                            children:const <Widget>[
                          ...
                          SizedBox(
                            height: _screenHeight * .016, //strech
                          ),
                          Positioned(
                            top: 0,
                            child: Container(
                                    ...
                                    children: <Widget>[
                                      ...
                                      Column(
                                        ...
                                        children: <Widget>[
                                          Row(
                                            children:const <Widget>[
                                              Text("Pipocas",style: TextStyle(fontWeight: FontWeight.bold, fontSize: 20, color: Colors.white),)
                                            ],
                                          ...
                                          Row(
                                            children:const <Widget>[
                                              Text("preferência",style: TextStyle(fontWeight: FontWeight.bold, fontSize: 12, color: Colors.white),)
                                            ],
                                          ),
                                          Row(
                                            children: <Widget>[
                          ...
                          SizedBox(
                            height: _screenHeight * .014, //strech
                          ),
                          Positioned(
                            top: 0,
                            child: Container(
                                    ...
                                    children: <Widget>[
                                      ...
                                      Column(
                                        ...
                                        children: <Widget>[
                                          Row(
                                            children:const <Widget>[
                                              Text("Bebidas",style: TextStyle(fontWeight: FontWeight.bold, fontSize: 20, color: Colors.white),)
                                            ],

                                          ),
                                          Row(
                                            children:const <Widget>[
                                              Text("Selecione o sabor de sua",style: TextStyle(fontWeight: FontWeight.bold, fontSize: 15, color: Colors.white),)
                                            ],
                                          ),
                                          Row(
                                            children:const <Widget>[
                          ...
                          SizedBox(
                            height: _screenHeight * .012, //strech
                          ),
                          Positioned(
                            top: 0,
                            child: Container(
                                    ...
                                    children: <Widget>[
                                      ...
                                      Column(
                                        ...
                                        children: <Widget>[
                                          Row(
                                            children:const <Widget>[
                                              Text("Doces",style: TextStyle(fontWeight: FontWeight.bold, fontSize: 20, color: Colors.white),)
                                            ],
