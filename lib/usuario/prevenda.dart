...
class prevenda extends StatefulWidget {
  const prevenda({Key? key}) : super(key: key);

  @override
  State<prevenda> createState() => _prevenda();
}

class _prevenda extends State<prevenda> {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        ...
        appBar: AppBar(title:const Text('      Pre venda 🎬',style: TextStyle(
            fontSize: 28,
