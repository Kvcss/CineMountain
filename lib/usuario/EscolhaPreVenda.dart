...
class EscolhaPreVenda extends StatefulWidget {
  Filmes getFilme = Filmes();


  EscolhaPreVenda(this.getFilme,{Key? key}) : super(key: key);
  @override
  State<EscolhaPreVenda> createState() => _EscolhaPreVendaState();
}

class _EscolhaPreVendaState extends State<EscolhaPreVenda> {
  String teste1= "SEG.";
